...
sprite_t minusBase = { 1, 24, minusBase_array };

sprite_t minusUnpressed = { 2, 24, minusUnpressed_array };

sprite_t minusChanging = { 2, 24, minusChanging_array };

sprite_t minusPressed = { 2, 24, minusPressed_array };
